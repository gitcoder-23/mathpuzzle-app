...
import 'package:mathspuzzle/ui/picturePuzzle/circle_shape.dart';
import 'package:mathspuzzle/ui/picturePuzzle/picture_puzzle_answer_button.dart';
import 'package:mathspuzzle/ui/picturePuzzle/square_shape.dart';
        ...
        return Expanded(
          ...
          child: Container(
            ...
            child: getTextWidget(Theme.of(context).textTheme.titleSmall!,
                picturePuzzleShape.text, TextAlign.start, getPercentSize(width, 70)),
