...
import 'package:mathspuzzle/ui/magicTriangle/triangle_button.dart';
...
class TriangleInput4x4 extends StatelessWidget {
  ...
  Widget build(BuildContext context) {
    ...
    Widget spaceWidget = SizedBox(width: getPercentSize(horizontalSpace, 10),);
