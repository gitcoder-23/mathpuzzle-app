...
class _LevelViewState extends State<LevelView> with TickerProviderStateMixin {
  ...
  Widget build(BuildContext context) {
    ...
    var widthItem =
        (getWidthPercentSize(context, 100) - ((_crossAxisCount - 1) * _crossAxisSpacing)) /
            _crossAxisCount;
            ...
            children: [
              ...
              Expanded(
                child: NotificationListener<OverscrollIndicatorNotification>(
                  ...
                  child: Container(
                    decoration: getDefaultDecoration(bgColor:widget.tuple2.item2.bgColor,
                    ...
                    child: GridView.count(
                      ...
                      primary: false,
                      padding: EdgeInsets.symmetric(vertical: getScreenPercentSize(context, 2.3),horizontal: (margin*1.3)),
                      children: List.generate(defaultLevelSize, (index) {
                        ...
                        animationController!
                            .forward();
                        return buildAnimatedItem(context, index, animation,InkWell(
                          child: Container(
                            height: height,
                            ...
                            child: Column(
                              ...
                              children: [
                                ...
                                getTextWidget(Theme.of(context).textTheme.titleSmall!
                                    .copyWith(fontWeight: FontWeight.w500,fontFamily: "OriginalSurfer"),
                                    '${(index+1)}',
                                    TextAlign.center,
                                    getPercentSize(height, 28)),

                                SizedBox(height:getPercentSize(height, 5) ,),
                                Container(
                                  decoration: BoxDecoration(
                                    borderRadius: BorderRadius.all(Radius.circular(
                                        getPercentSize(height, 95))),
                                    color: widget.tuple2.item2.backgroundColor,
                                  ),
                                  margin: EdgeInsets.symmetric(
                                  ...
                                  child: Center(
                                    child:  getTextWidget(Theme.of(context).textTheme.titleSmall!
                          ...
                          onTap: () {
                            ...
                            showInterstitialAd(adsFile, (){
                              ...
                              model.backgroundColor = widget.tuple2.item2.backgroundColor;
  ...
  Widget buildAnimatedItem(
      ...
      // For maths wrap with fade transition
  FadeTransition(
