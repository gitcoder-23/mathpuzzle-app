      ...
      children: [
        SlideTransition(
          child: FadeTransition(
            ...
            child: getTextWidget(Theme.of(context).textTheme.titleSmall!, widget.oldScore < widget.currentScore
                    ? widget.currentScore.toString()
                    : widget.oldScore.toString(), TextAlign.center, getPercentSize(height, 40)),
        ...
        SlideTransition(
          child: FadeTransition(
            opacity: _opacityAnimationOut,
              ...
              child:  getTextWidget(Theme.of(context).textTheme.titleSmall!.copyWith(fontWeight: FontWeight.bold),
                    widget.oldScore > widget.currentScore
                        ? widget.currentScore.toString()
                        : widget.oldScore.toString(),

                  TextAlign.center, getPercentSize(height, 40))
          ),
